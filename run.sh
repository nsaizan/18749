...
gnome-terminal -e "bash -c \"python3 $PWD/replication-manager/replication-manager.py;exec bash\"" --title="RM"
gnome-terminal -e "bash -c \"python3 $PWD/global-detector/global-detector.py 10;exec bash\"" --title="GFD"
gnome-terminal --tab -e "bash -c \"python3 $PWD/detector/detector.py 1 10;exec bash\"" --title="LFD 1" --tab -e "bash -c \"python3 $PWD/detector/detector.py 2 10;exec bash\"" --title="LFD 2" --tab -e "bash -c \"python3 $PWD/detector/detector.py 3 10;exec bash\"" --title="LFD 3"
gnome-terminal --tab -e "bash -c \"python3 $PWD/server/server.py 1 2;exec bash\"" --title="SERVER 1" --tab -e "bash -c \"python3 $PWD/server/server.py 2 2;exec bash\"" --title="SERVER 2" --tab -e "bash -c \"python3 $PWD/server/server.py 3 2;exec bash\"" --title="SERVER 3"
